...
const Explore = (0, import_index_33f79e25.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="${"pageWrap"}">${(0, import_index_33f79e25.v)(import_Header_990c3051.H, "Header").$$render($$result, {}, {}, { default: () => `EXPLORE` })}
    <section id="${"facility"}" class="${"svelte-4iqqz1"}"><h2>Facility</h2>
    ...
    <section id="${"trainers"}" class="${"svelte-4iqqz1"}"><h2>Personal Trainers</h2>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo, inventore recusandae. Nostrum explicabo quibusdam cumque nam beatae consequuntur. Necessitatibus beatae maiores nostrum cupiditate unde sequi aperiam omnis nesciunt ratione sit.</p></section>
    <section id="${"services"}" class="${"svelte-4iqqz1"}"><h2>Services</h2>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo, inventore recusandae. Nostrum explicabo quibusdam cumque nam beatae consequuntur. Necessitatibus beatae maiores nostrum cupiditate unde sequi aperiam omnis nesciunt ratione sit.</p></section>
</div>`;
});
