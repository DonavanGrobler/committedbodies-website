...
<div class="pageWrap" in:slideFadeIn out:slideFadeOut>
    ...
    <section class="testing">
        <header id="top" role="banner">
            ...
            <p>This is a test page filled with common HTML elements to be used to provide visual feedback for the global stylesheet: /src/styles/app.scss</p>
            <p><a href="/">Go back to the Home Page</a></p>
            <a href="#testModal">TEMPORARY LINK FOR TESTING MODAL</a>
        </header>
    </section>
    ...
    <!-- <section class="" id="embedded">
        ...
        <article id="embedded__iframe">
            ...
            <div><iframe title="Testing iframe" src="HTML5 Test page.html" height="300"></iframe></div>
            <footer><p><a href="#top">[Top]</a></p></footer>
        </article>
    </section>

    <section class="" id="forms">
